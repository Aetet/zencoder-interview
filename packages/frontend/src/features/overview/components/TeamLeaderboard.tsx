  ...
  return (
    <Card className="flex flex-col p-0 overflow-hidden">
      <div className="flex items-center justify-between px-6 pt-6 pb-3">
        ...
        <span className="text-[11px] text-foreground-muted">{formatNumber(sorted.length)} teams</span>
      </div>
          ...
          <tbody>
            {sorted.map((t, i) => (
              ...
              >
                ...
                <td className={cn('py-2 px-4 text-[13px] tabular-nums', t.completionRate >= 0.85 ? 'text-success' : 'text-warning', live && 'live-value')}>
