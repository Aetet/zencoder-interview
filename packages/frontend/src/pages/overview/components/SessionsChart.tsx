...
export const SessionsChart = reatomComponent(() => {
  const { sessionTrend: data } = overviewRoute.view()
    ...
    <Card>
      ...
      <ResponsiveContainer width="100%" height={220}>
        <BarChart data={data}>
          ...
          <Bar dataKey="completed" stackId="a" fill="#218b30" isAnimationActive={!active} animationDuration={active ? 150 : 400} />
          <Bar dataKey="errored" stackId="a" fill="#d1003e" isAnimationActive={!active} animationDuration={active ? 150 : 400} />
          <Bar dataKey="cancelled" stackId="a" fill="#9f9e9c" radius={[2, 2, 0, 0]} isAnimationActive={!active} animationDuration={active ? 150 : 400} />
        </BarChart>
      </ResponsiveContainer>
    </Card>
  )
